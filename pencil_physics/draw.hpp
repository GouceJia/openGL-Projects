...
public:
    ...
    void circle(mat4 transform, float angle, vec2 center, float radius, vec3 color);
    void box(mat4 transform, float angle, vec2 center, vec2 size, vec3 color);
...
inline void Draw::circle(mat4 transform, float angle, vec2 center, float radius, vec3 color) {
//    glPopMatrix();
...
inline void Draw::box(mat4 transform, float angle, vec2 center, vec2 size, vec3 color) {
    transform = glm::translate(transform, vec3(center, 0));
    transform = glm::rotate(transform, angle, vec3(0, 0, 1));
